...
class _ImageUploadPageState extends State<ImageUploadPage>
  ...
  void dispose() {
    ...
    FirebaseStorage.instance.ref().child(r.toString() + "." + filtype);

    StorageUploadTask upload = ref.put(file);

    Uri downloadUrl = (await upload.future).downloadUrl;

    print(downloadUrl.toString());

    reference.push().set({"image": downloadUrl.toString()});
                      ...
                      new Container(
                        ...
                        child: new TextField(
                          ...
                          decoration: new InputDecoration.collapsed(
                              hintText: filesSub[filesSub.length - 1]
                                  .split(".")[0],
